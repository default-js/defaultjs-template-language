...
class Context {
	constructor({ resolver, renderer, template, container, root, mode = "replace", target = null, parent = null, ignoreDirective = new Set() }) {
		...
		this.wait = Object(_Wait__WEBPACK_IMPORTED_MODULE_0__["default"])(this);
	...
	acceptDirective(directive) {
		if (directive instanceof _Directive__WEBPACK_IMPORTED_MODULE_1__["default"]) return !(this.ignoreDirective.has(directive.name) || this.ignoreDirective.has(directive));
...
class Renderer {
	...
	async render({ template = null, data = null, container, root, mode, target, context = null }) {
		...
		if (!renderContext) renderContext = new _Context_js__WEBPACK_IMPORTED_MODULE_3__["default"]({ resolver, renderer: this, template, container, root: root ? root : container, mode: mode ? mode : "replace", target });
		...
		if (result instanceof _Context_js__WEBPACK_IMPORTED_MODULE_3__["default"]) renderContext = result;
	...
	async renderNode(context) {
		try {
			...
			if (context.template instanceof _Element_js__WEBPACK_IMPORTED_MODULE_5__["default"]) await context.template.execute(context);
		...
		for (let i = 0; i < length && !context.stop; i++) {
			...
			try {
				if (context.acceptDirective(directive)) {
					...
					if (result instanceof _Context_js__WEBPACK_IMPORTED_MODULE_3__["default"]) context = result;
				}
			} catch (e) {
